...
- [x] **ขัดเกลางานภาพระดับสูง (Viral Spectacle Polish):**
  ...
  - [x] ลบเอฟเฟกต์วงแหวนใต้เท้ามอนสเตอร์ออกเพื่อลดความรกของหน้าจอ (User Feedback Polish)
  - [x] เปลี่ยนป้ายแสดงชื่อบนหัวมอนสเตอร์และบอสจากอิโมจิเป็นภาษาอังกฤษ (User Feedback Polish)
  - [x] เปลี่ยนระบบ Threat Level และ Vaccine จากค่าเดียวเป็นแยก 4 โซน พร้อมเปลี่ยนจากการกวาดล้างรักษาทั้งหมดเป็นการเรียก Doctor NPC ลงพื้นที่มาเดินฮีลและรักษาโรคทีละตัว (User Feedback Polish)
  - [x] เปลี่ยนระบบบอสจากเกิดทีละตัวทั้งเกม เป็นเกิดแยกประจำ 4 โซนอิสระ (Thunderclap, Inferno, Vortex, Supreme) พร้อมระบบซิงค์ UI หลอดเลือดบอสแบบไดนามิกตามโซนที่ผู้เล่นกำลังยืนอยู่ (User Feedback Polish)
  - [x] ซ่อนป้ายชื่อและหลอดเลือดบนหัวมอนสเตอร์/หมอ/บอสเมื่อผู้เล่นซูมหน้าจอออกห่าง (MaxDistance 100-150 studs) (User Feedback Polish)
  - [x] พัฒนาระบบตั้งค่าพื้นฐาน (Settings Panel) สำหรับปรับปรุงประสิทธิภาพและ Game Feel (SFX, Particles, Screen Shake, Damage Popups)
  - [x] แสดงคะแนน DNA ที่ได้รับสะสมใต้ป้าย Combo (+X DNA) และซ่อนการแสดงป๊อปอัปกลางหน้าจอแยกกันเพื่อไม่ให้เกะกะสายตา (ปรับปรุงให้แสดงผลเฉพาะตอนได้รับจริง ไม่สะสมสะแต็คตามความเห็นผู้ใช้)
  - [x] ระบบวิ่งเร็ว (Sprint - LeftShift) และระบบพุ่งแดชระยะ 40 studs (Dash - Q) ตรวจสอบ Raycast ป้องกันสิ่งกีดขวางทึบ
