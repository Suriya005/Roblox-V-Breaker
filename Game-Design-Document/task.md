...
- [ ] **ระบบ UI พื้นฐาน (Main HUD):**
  - [ ] สร้างหน้าต่างแสดงผลจำนวน Bio Points และ DNA Points
- [ ] **งานภาพและ Game Feel (Visual & Juice):**
  - [ ] ใส่ Particle Emitter สีเขียวสะท้อนแสงเวลาติดเชื้อ
  - [ ] ติดตั้งระบบ Screen Shake เบื้องต้นเมื่อเกิดเหตุการณ์สำคัญ
